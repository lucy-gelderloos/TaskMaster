...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void setUpSignUpForm(){
        ...
        findViewById(R.id.buttonSignupActivitySignUp).setOnClickListener(view -> {
            String userEmail = ((EditText)findViewById(R.id.editTextSignupEmail)).getText().toString();
            String userPassword = ((EditText) findViewById(R.id.editTextSignupPassword)).getText().toString();
